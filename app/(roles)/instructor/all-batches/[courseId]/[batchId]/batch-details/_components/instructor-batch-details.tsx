...
import BatchModeSelector from "@/app/(roles)/admin/all-batches/[courseId]/[batchId]/batch-details/_components/batch-mode-selector";
import BatchTypeSelector from "@/app/(roles)/admin/all-batches/[courseId]/[batchId]/batch-details/_components/batch-type-selector";
import BatchStatusSelector from "@/app/(roles)/admin/all-batches/[courseId]/[batchId]/batch-details/_components/batch-status-selector";
import BatchNotesTable from "@/app/(roles)/admin/all-batches/[courseId]/[batchId]/batch-details/_components/batch-notes-table";
import BatchStudentTable from "@/app/(roles)/admin/all-batches/[courseId]/[batchId]/batch-details/_components/batch-student-table";
import InstructorBatchMeetings from "./instructor-batch-meetings";
type InstructorBatchDetailsProps = {
  batch: Batch;
  dummyModules: string[];
...
const InstructorBatchDetails = ({
  batch,

  
  courseId,
}: InstructorBatchDetailsProps) => {

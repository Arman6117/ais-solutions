        ...
        <div className="flex flex-wrap justify-between">
          <div className="flex flex-col gap-2 w-full">
            ...
            <Link href={`/student/courses/course-details/${course._id}`}>
              <Button
                className="border-primary-bg w-full  text-lg cursor-pointer text-primary-bg hover:bg-primary-bg/10 hover:text-primary-bg"
                variant={"outline"}
              >
                Add To My Course
              </Button>
            </Link>
            <Link href={course.syllabusLink} className="z-10" target="_blank" rel="noopener noreferrer">
              <Button
                className="border-gray-700 w-full  text-lg cursor-pointer text-black hover:bg-black hover:text-white"
                variant={"outline"}
              >
                Download Syllabus
              </Button>

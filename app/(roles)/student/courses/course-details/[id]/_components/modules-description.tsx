...
const ModulesDescription = ({ modules }: ModulesDescriptionProps) => {
  return (
          ...
          >
            <AccordionItem value={m.name}>
              ...
              <AccordionContent className="flex flex-col">
                ...
                <h3 className="text-[16px]  font-medium">Download Module Syllabus</h3>
                <Button className="bg-primary-bg rounded-full cursor-pointer" size={'sm'}>
                    <Download/>
                </Button>

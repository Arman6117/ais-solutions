...
const LectureScheduleCard = ({ day }: LectureScheduleCardProps) => {
  return (
    <div
      className={`relative w-64 group sm:w-96  max-w-full bg-soft-white rounded-xl shadow-primary-bg/10 shadow-lg transition-all duration-300 hover:shadow-xl hover:scale-[1.02] cursor-pointer group overflow-hidden`}
    >

...
import {
  ...
  ArrowLeft,
  AlertCircle,
  Briefcase, // Using Briefcase icon for Instructor
} from "lucide-react";
...
import { loginInstructor } from "@/actions/instructor/login-instructor"; // Import the new action
...
const InstructorLoginForm = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await loginInstructor(data);

      if (res.success) {
        toast.success("Login successful!");
        // Redirect to the instructor's batches page as requested
        router.push("/instructor/all-batches"); 
      } else {
      ...
      <div className="w-full max-w-md">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>Login to your instructor account</CardDescription>
          </CardHeader>

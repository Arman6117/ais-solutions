      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500">
              {instructors.length} instructor{instructors.length !== 1 && "s"} assigned to this course
            </p>
          </div>
          {mode === "edit" && (
            <Button
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
          {instructors.map((instructor) => (
            <HoverCard key={instructor.id}>
                    ...
                    <div className="flex items-center gap-4 relative">
                      ...
                      {mode === "edit" && (
                        <Button
                          ...
                          onClick={() => toast.success(`${instructor.name} removed from course`)}
                        >
                          <Trash2 size={16} />
                        </Button>
                      )}
              ...
              <HoverCardContent
                align="start"
                className="w-96 max-h-96 bg-white border border-gray-200 p-0 rounded-lg shadow-lg overflow-hidden"
              >
                  ...
                  <div className="p-5 space-y-5">
                    ...
                    <div className="space-y-3">
                      ...
                      <div className="space-y-2">
                        {[
                          { name: "Morning Batch", students: 25, period: "May - Aug 2025" },
                          { name: "Weekend Batch", students: 18, period: "Jun - Oct 2025" }
                        ].map((batch, idx) => (
                          <div key={idx} className="flex items-center justify-between bg-gray-50 rounded-md p-2 text-sm">
        ...
        {instructors.length === 0 && (
          <div className="text-center p-10 border border-dashed border-gray-300 rounded-lg bg-gray-50">
            ...
            <h3 className="text-lg font-medium text-gray-700 mb-1">No instructors yet</h3>
